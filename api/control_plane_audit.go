...
type ControlPlaneAuditEvent struct {
	...
	CampaignDraftID                  *uuid.UUID      `json:"campaignDraftId,omitempty"`
	CampaignRevisionID               *uuid.UUID      `json:"campaignRevisionId,omitempty"`
	CampaignRunID                    *uuid.UUID      `json:"campaignRunId,omitempty"`
	CampaignWaveDefinitionID         *uuid.UUID      `json:"campaignWaveDefinitionId,omitempty"`
	CampaignWaveRunID                *uuid.UUID      `json:"campaignWaveRunId,omitempty"`
	CampaignMemberID                 *uuid.UUID      `json:"campaignMemberId,omitempty"`
	CampaignMemberRunID              *uuid.UUID      `json:"campaignMemberRunId,omitempty"`
	CampaignControlRequestID         *uuid.UUID      `json:"campaignControlRequestId,omitempty"`
	CampaignExclusionID              *uuid.UUID      `json:"campaignExclusionId,omitempty"`
	CampaignPrerequisiteEvaluationID *uuid.UUID      `json:"campaignPrerequisiteEvaluationId,omitempty"`
	CampaignThresholdEvaluationID    *uuid.UUID      `json:"campaignThresholdEvaluationId,omitempty"`
	...
	CampaignRevisionChecksum         string          `json:"campaignRevisionChecksum,omitempty"`
	CampaignControlChecksum          string          `json:"campaignControlChecksum,omitempty"`
