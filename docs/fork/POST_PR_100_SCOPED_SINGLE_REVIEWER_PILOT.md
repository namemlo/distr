...
- Feature flag: default-off `scoped_single_reviewer_pilot`.
...
- Protected history: same issuer/reviewer is accepted only for the exact configured target with no customer-wide scope.
