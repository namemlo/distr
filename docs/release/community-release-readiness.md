...
ordered 138-to-164 migration matrix and is not a general retention or bulk-delete facility. Before invoking it,
...
| ---------------------------------------------------------------------------------------------------------- | -------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| PostgreSQL 16.14 and 18.4 clean install, upgrade 138-to-164, safe down/refusal, and restart matrix         | Pending environment execution    | Database identity, commands, schema checkpoints, exact results, and migration-report checksum                       |
