...
func AppendControlPlaneAuditEventInCurrentBoundary(
	...
	rows, err := database.Query(ctx, `
			...
			VALUES (
				...
				@sampleRetirementOwnershipEvidenceId,
				@sampleRetirementRecoveryEvidenceId,
				@protectedHistoryArtifactId,
				@releaseChecksum,
		...
		pgx.NamedArgs{
			...
			"sampleRetirementOwnershipEvidenceId": input.SampleRetirementOwnershipEvidenceID,
			"sampleRetirementRecoveryEvidenceId":  input.SampleRetirementRecoveryEvidenceID,
			"protectedHistoryArtifactId":          input.ProtectedHistoryArtifactID,
