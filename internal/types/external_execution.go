...
type ExternalExecution struct {
	...
	ExpectedComposeReference string                            `db:"expected_compose_reference" json:"expectedComposeReference"`
	ExpectedComposeChecksum  string                            `db:"expected_compose_checksum" json:"expectedComposeChecksum"`
	...
	ActivePreMutationHold    *ExternalExecutionPreMutationHold `db:"-" json:"-"`
}
