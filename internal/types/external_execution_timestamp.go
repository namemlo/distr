...
type ExternalExecutionTimestampVerificationReport struct {
	...
	ResolvedDeletedEvidenceCount   uint64    `json:"resolvedDeletedEvidenceCount"`
	UnresolvedDeletedEvidenceCount uint64    `json:"unresolvedDeletedEvidenceCount"`
	PostManifestPairedCount        uint64    `json:"postManifestPairedCount"`
	DeletionTombstoneRows          uint64    `json:"deletionTombstoneRows"`
	DeletedExecutionCount          uint64    `json:"deletedExecutionCount"`
