...
The full setup is in the [Kubernetes Compatibility Matrix guide](/docs/platform/kubernetes-compatibility-matrix/). The [hello-distr](https://github.com/distr-sh/hello-distr) repository has a complete working example with all the scripts and a GitHub Actions workflow you can adapt.

If you're already using Distr with the [automatic deployments from GitHub](/docs/integrations/github-actions/) workflow, this is a straightforward extension: three additional jobs in the same pipeline.
