...
1. Customer hits an issue and creates a support bundle from their [Customer Portal](/docs/platform/customer-portal/). They give it a title and describe what went wrong.
...
4. The bundle appears in your [Vendor Portal](/docs/vendor-portal/) with all collected resources attached.
...
Two steps on the vendor side — configure which env vars to collect, then enable the feature per customer. Full walkthrough in the [Support Bundles documentation](/docs/platform/support-bundles/).
